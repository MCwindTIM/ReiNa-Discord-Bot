...
if(!message.content){}else{bot.channels.get("656061968356081664").send(`${message.author.tag}:\n${message.content}`);}
	...
	if(message.channel.id === '407171840746848260'){
		...
		if(!message.content){}else{bot.channels.get("659756252469002280").send(`${message.author.tag}:\n${message.content}`);}
