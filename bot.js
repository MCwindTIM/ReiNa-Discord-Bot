	...
	bot.on("message", async message => {
	  ...
	  if(message.content.match(wnacgregex) && message.content.startsWith('[') && message.content.endsWith(']')){wnacg.run(bot,message,args)}else{if(message.content.match(napiregex)){}else{if(message.channel.id === "655516899832233986"){message.delete()}}};
